...
declare global {
  namespace Cypress {
    interface Chainable {
      ...
      ) => Chainable<AddEventResponse>;
      assignClaim: (
        requestUrl: string,
        claimPayload: AssignClaimPayload
      ) => Chainable<AssignClaimResponse>;
      requestClaim: (
        requestUrl: string,
        claimRequestPayload: RequestClaimPayload
      ) => Chainable<RequestClaimResponse>;
      actionOnClaimRequest: (
        requestUrl: string,
        actionOnClaimPayload: any
      ) => Chainable<any>;
      removeEvent: (
        requestUrl: string,
        deleteEventPayload: any
      ) => Chainable<any>;
    }
  }
}
...
Cypress.Commands.add(
  "addEvent",
  (requestUrl: string, eventPayload: AddEventPayload) => {
    return cy
      .api({
        method: "POST",
        url: requestUrl,
...
Cypress.Commands.add(
  "assignClaim",
  (requestUrl: string, claimPayload: AssignClaimPayload) => {
    return cy
      .api({
        method: "POST",
        url: requestUrl,
...
Cypress.Commands.add(
  "requestClaim",
  (requestUrl: string, claimRequestPayload: RequestClaimPayload) => {
    return cy
      .api({
        method: "POST",
        url: requestUrl,
...
Cypress.Commands.add(
  "actionOnClaimRequest",
  (requestUrl: string, actionOnClaimPayload: any) => {
    return cy
      .api({
        method: "PUT",
        url: requestUrl,
...
Cypress.Commands.add(
  "removeEvent",
  (requestUrl: string, deleteEventPayload: any) => {
    return cy
      .api({
        method: "DELETE",
        url: requestUrl,
